...
![Hero Section — "We pivot brands to new heights" with animated particles and typewriter effect](docs/screenshots/hero-section.png)
...
![About Section — Our Story with stats and organic leaf imagery](docs/screenshots/about-section.png)
...
![Services Section — Strategy, SEO, PPC cards with hover effects](docs/screenshots/services-section.png)
...
![Contact Section — "Let's build something remarkable" with contact card](docs/screenshots/contact-section.png)
...
│   │   ├── RootSystem.jsx      # Growing root/vine animation
...
git clone https://github.com/YOUR_USERNAME/pivot-media.git
